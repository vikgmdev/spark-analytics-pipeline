...
From Holden Karau's High Performance Spark
  https://github.com/holdenk/com.mantix4.ap.spark-structured-streaming-ml/blob/master/src/main/scala/com/high-performance-com.mantix4.ap.spark-examples/structuredstreaming/CustomSink.scala#L66
  *
  */
