...
object Files extends LogBase {
  ...
  val schemaBase: StructType = new StructType()
    ...
    .add("depth", StringType)
    .add("analyzers", ArrayType(StringType))
    .add("mime_type", StringType)
    .add("filename", StringType)
    .add("duration", StringType)
    .add("local_orig", StringType)
    .add("is_orig", StringType)
    .add("seen_bytes", StringType)
    .add("total_bytes", StringType)
    .add("missing_bytes", StringType)
    .add("overflow_bytes", StringType)
    .add("timedout", StringType)
