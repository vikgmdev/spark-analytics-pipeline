...
object Conn {
  ...
  val schemaBaseCSV: StructType = new StructType()
    ...
    .add("source_ip", StringType, nullable = true)
    .add("source_port", StringType, nullable = true)
    .add("dest_ip", StringType, nullable = true)
    .add("dest_port", StringType, nullable = true)
    .add("proto", StringType, nullable = true)
    .add("service", StringType, nullable = true)
    .add("duration", StringType, nullable = true)
    .add("orig_bytes", StringType, nullable = true)
    .add("resp_bytes", StringType, nullable = true)
    .add("conn_state", StringType, nullable = true)
    .add("local_orig", StringType, nullable = true)
    .add("local_resp", StringType, nullable = true)
    .add("missed_bytes", StringType, nullable = true)
    .add("history", StringType, nullable = true)
    .add("orig_pkts", StringType, nullable = true)
    .add("orig_ip_bytes", StringType, nullable = true)
    .add("resp_pkts", StringType, nullable = true)
    .add("resp_ip_bytes", StringType, nullable = true)
}
